module github.com/samvaughton/wpcommand/v2
...
require (
	...
	github.com/uptrace/bun/dialect/pgdialect v1.0.2
	github.com/uptrace/bun/driver/pgdriver v0.3.9 // indirect
	github.com/uptrace/bun/extra/bundebug v1.0.9 // indirect
